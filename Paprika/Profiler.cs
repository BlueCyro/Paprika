...
public static class Profiler
{
    ...
    {
        public readonly PInvoke.TracyCZoneContext ctx;

        public ProfilerScope(PInvoke.TracyCZoneCtx ctx)
        {
            this.ctx = ctx;
        }
        ...
        [CallerLineNumber] int lineNumber = 0)
    {
        ...
        var srcLoc = PInvoke.TracyAllocSrcloc((uint)lineNumber, tuple.Item1, (ulong)scriptPath.Length, tuple.Item2, (ulong)functionName.Length);
        var ctx = PInvoke.TracyEmitZoneBeginAlloc(srcLoc, 1);

        if (colorType != default)
        {
            PInvoke.TracyEmitZoneColor(ctx, (uint)colorType);
        }
    ...
    public static void ProfileFrame(string name)
    {
        ...
        PInvoke.TracyEmitFrameMark(frameName);
    }
